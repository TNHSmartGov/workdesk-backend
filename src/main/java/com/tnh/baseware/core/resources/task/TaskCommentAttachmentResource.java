...
public class TaskCommentAttachmentResource extends
        GenericResource<TaskCommentAttachment, TaskCommentAttachmentEditorForm, TaskCommentAttachmentDTO, UUID> {

    ITaskCommentAttachmentService taskCommentAttachmentService;

    public TaskCommentAttachmentResource(
            IGenericService<TaskCommentAttachment, TaskCommentAttachmentEditorForm, TaskCommentAttachmentDTO, UUID> service,
